			...
			>
				...
				<div className="grid grid-cols-3 gap-2 mb-5 pt-4">
					<div className="w-24 h-16 border bg-slate-50 p-2 text-center ">
						<p className="text-lg font-fabrikat text-slate-900">
							{stats.todo}
						</p>
						<p className="text-[12px] font-fabrikat text-slate-400">
							To do
						</p>
					</div>
					<div className="w-24 h-16 border bg-blue-50  p-2 text-center">
						<p className="text-lg font-fabrikat text-blue-700">
							{stats.inProgress}
						</p>
						<p className="text-[12px] font-fabrikat text-blue-400">
							In progress
						</p>
					</div>
					<div className="w-24 h-16 border bg-emerald-50  p-2 text-center">
						<p className="text-lg font-fabrikat text-emerald-700">
							{stats.done}
						</p>
						<p className="text-[12px] font-fabrikat text-emerald-400">
							Done
						</p>
					</div>
				</div>
				...
				<div className="divide-y divide-slate-50">
					<InfoRow
						icon={ClockCheckIcon}
						label="Created"
						value={formatDeadline(project.createdAt)}
					/>
					{project.deadline && (
						<InfoRow
							label="Deadline"
